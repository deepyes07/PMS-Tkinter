...
def update():
    ...
    quit_button = Button(top, text='Quit', border=1, width=15, height=2,
...
category = Button(text='Category', width=19, height=2, border=0, bg='#ADD8E6',  # Light blue
                  fg='black', font=("Inter", 10, "bold"), cursor='hand2', command=category)
