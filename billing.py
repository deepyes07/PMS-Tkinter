...
root.state("zoomed")
# ****************************dashboard frame************************************
frame = Frame(width=160, padx=30, bg='#ADD8E6')  # Light blue
frame.pack(side=LEFT, fill=Y)


# ****************************logo image************************************
logoImg = PhotoImage(file='./assets/logo.png')
logo = Label(image=logoImg, bg='#ADD8E6', fg='black', width=159, height=27)  # Light blue
logo.place(x=0, y=0)
...
dash = Button(text='Dashboard', width=19, height=2, border=0, bg='#ADD8E6',  # Light blue
              fg='black', font=("Inter", 10, "bold"), cursor='hand2', command=dashboard)
dash.place(x=1, y=30)
medicine = Button(text='Medicine', border=0, bg='#ADD8E6', fg='black', font=(
...
billing = Button(text='Billing', width=19, border=0, bg='#ADD8E6', fg='black', font=(
    "Inter", 10, "bold"), cursor='hand2', command=billing)
billing.place(x=1, y=170, height=40)
# userimg=PhotoImage(file='category.png')
# img=Label(root,image=userimg,bg='#ADD8E6')
# img.place(x=1,y=135)
# indicator for billing
billing_indicator = Button(root, text='', bg='#ADD8E6')  # Light blue
...
# *******header frame *******
frame1 = Frame(root, bg='#E0FFFF')  # Light cyan background for header
frame1.place(x=164, y=0, width=1150, height=60)


# ***********heading********************************
heading = Label(frame1, text='ABC Pharmacy Store', bg='#E0FFFF',
                fg='black', font=("camb", 20, 'bold'))
heading.place(x=100, y=5)

# ************* profile image****************************
profileImg = PhotoImage(file='./assets/profile.png')
profile = Label(image=profileImg, fg='black', bg='#E0FFFF')
profile.place(x=1050, y=0)
name = Label(text="Admin", fg='black', bg='#E0FFFF', font=("Poppins", 10))
name.place(x=1100, y=25)
name = Label(text="Test", bg='#E0FFFF',
...
next_button = Button(root, text='NEXT', border=1, width=15, height=2,
                     bg='#3ECF0A', fg='#E0FFFF', font=("Poppins", 10), command=next)
next_button.place(x=880, y=550)

save_button = Button(root, text='Save Customer', border=1, width=20,
                     height=2, bg='#ADD8E6', fg='black', font=("Poppins", 10), command=save)
