...
# ****************************dashboard frame************************************
frame = Frame(width=160, padx=30, bg='#ADD8E6')  # Light blue background
...
dash = Button(text='Dashboard', border=0, bg='#ADD8E6', fg='black', font=(
    "Inter", 10, "bold"), cursor='hand2', command=dashboard)
dash.place(x=1, y=30)

medicine = Button(text='Medicine', width=19, height=2, border=0, bg='#ADD8E6', fg='black', font=(
...
category = Button(text='Category', border=0, bg='#ADD8E6', fg='black', font=(
    "Inter", 10, "bold"), cursor='hand2', command=category)  # Font bold for category
category.place(x=10, y=130)

categoryimg = PhotoImage(file='./assets/category.png')
img = Label(root, image=categoryimg, bg='#ADD8E6')
img.place(x=1, y=135)
...
billing = Button(text='Billing', border=0, bg='#ADD8E6', fg='black', font=(
    "Inter", 10, "bold"), cursor='hand2', command=billing)  # Font bold for billing
billing.place(x=10, y=170)

setting = Button(text='Pharmacy Setting', border=0, bg='#ADD8E6', fg='black', font=(
    "Inter", 10, "bold"), cursor='hand2', command=setting)  # Font bold for setting
setting.place(x=10, y=210)

# ***************log out button*******************************
logout = Button(text='Log Out', border=0, bg='#ADD8E6', fg='black', font=(
    "Inter", 10, "bold"), cursor='hand2', command=logout)  # Font bold for logout
